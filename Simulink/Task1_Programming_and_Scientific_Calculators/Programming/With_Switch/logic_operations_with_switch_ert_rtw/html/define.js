...
this.def["logic_operations_with_switch_U"] = {file: "logic_operations_with_switch_c.html",line:23,type:"var"};
this.def["logic_operations_with_switch_Y"] = {file: "logic_operations_with_switch_c.html",line:26,type:"var"};
this.def["logic_operations_with_switch_M_"] = {file: "logic_operations_with_switch_c.html",line:29,type:"var"};
this.def["logic_operations_with_switch_M"] = {file: "logic_operations_with_switch_c.html",line:30,type:"var"};
this.def["logic_operations_with_switch_step"] = {file: "logic_operations_with_switch_c.html",line:34,type:"fcn"};
this.def["logic_operations_with_switch_initialize"] = {file: "logic_operations_with_switch_c.html",line:159,type:"fcn"};
this.def["logic_operations_with_switch_terminate"] = {file: "logic_operations_with_switch_c.html",line:179,type:"fcn"};
this.def["ExtU_logic_operations_with_sw_T"] = {file: "logic_operations_with_switch_h.html",line:47,type:"type"};
this.def["ExtY_logic_operations_with_sw_T"] = {file: "logic_operations_with_switch_h.html",line:58,type:"type"};
this.def["RT_MODEL_logic_operations_wit_T"] = {file: "logic_operations_with_switch_types_h.html",line:23,type:"type"};
...
function Html2SrcLink() {
	...
	this.html2SrcPath["logic_operations_with_switch_c.html"] = "../logic_operations_with_switch.c";
	this.html2Root["logic_operations_with_switch_c.html"] = "logic_operations_with_switch_c.html";
	this.html2SrcPath["logic_operations_with_switch_h.html"] = "../logic_operations_with_switch.h";
	this.html2Root["logic_operations_with_switch_h.html"] = "logic_operations_with_switch_h.html";
	this.html2SrcPath["logic_operations_with_switch_private_h.html"] = "../logic_operations_with_switch_private.h";
	this.html2Root["logic_operations_with_switch_private_h.html"] = "logic_operations_with_switch_private_h.html";
	this.html2SrcPath["logic_operations_with_switch_types_h.html"] = "../logic_operations_with_switch_types.h";
	this.html2Root["logic_operations_with_switch_types_h.html"] = "logic_operations_with_switch_types_h.html";
...
var fileList = [
"ert_main_c.html","logic_operations_with_switch_c.html","logic_operations_with_switch_h.html","logic_operations_with_switch_private_h.html","logic_operations_with_switch_types_h.html","rtGetInf_c.html","rtGetInf_h.html","rtGetNaN_c.html","rtGetNaN_h.html","rt_nonfinite_c.html","rt_nonfinite_h.html","rtwtypes_h.html"];
