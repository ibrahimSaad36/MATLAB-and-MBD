...
this.def["calculator_using_switch_B"] = {file: "calculator_using_switch_c.html",line:23,type:"var"};
this.def["calculator_using_switch_U"] = {file: "calculator_using_switch_c.html",line:26,type:"var"};
this.def["calculator_using_switch_Y"] = {file: "calculator_using_switch_c.html",line:29,type:"var"};
this.def["calculator_using_switch_M_"] = {file: "calculator_using_switch_c.html",line:32,type:"var"};
this.def["calculator_using_switch_M"] = {file: "calculator_using_switch_c.html",line:33,type:"var"};
this.def["calculator_using_switch_step"] = {file: "calculator_using_switch_c.html",line:37,type:"fcn"};
this.def["calculator_using_switch_initialize"] = {file: "calculator_using_switch_c.html",line:116,type:"fcn"};
this.def["calculator_using_switch_terminate"] = {file: "calculator_using_switch_c.html",line:142,type:"fcn"};
this.def["B_calculator_using_switch_T"] = {file: "calculator_using_switch_h.html",line:45,type:"type"};
this.def["ExtU_calculator_using_switch_T"] = {file: "calculator_using_switch_h.html",line:52,type:"type"};
this.def["ExtY_calculator_using_switch_T"] = {file: "calculator_using_switch_h.html",line:57,type:"type"};
this.def["RT_MODEL_calculator_using_swi_T"] = {file: "calculator_using_switch_types_h.html",line:23,type:"type"};
...
function Html2SrcLink() {
	...
	this.html2SrcPath["calculator_using_switch_c.html"] = "../calculator_using_switch.c";
	this.html2Root["calculator_using_switch_c.html"] = "calculator_using_switch_c.html";
	this.html2SrcPath["calculator_using_switch_h.html"] = "../calculator_using_switch.h";
	this.html2Root["calculator_using_switch_h.html"] = "calculator_using_switch_h.html";
	this.html2SrcPath["calculator_using_switch_private_h.html"] = "../calculator_using_switch_private.h";
	this.html2Root["calculator_using_switch_private_h.html"] = "calculator_using_switch_private_h.html";
	this.html2SrcPath["calculator_using_switch_types_h.html"] = "../calculator_using_switch_types.h";
	this.html2Root["calculator_using_switch_types_h.html"] = "calculator_using_switch_types_h.html";
...
var fileList = [
"ert_main_c.html","calculator_using_switch_c.html","calculator_using_switch_h.html","calculator_using_switch_private_h.html","calculator_using_switch_types_h.html","rtGetInf_c.html","rtGetInf_h.html","rtGetNaN_c.html","rtGetNaN_h.html","rt_nonfinite_c.html","rt_nonfinite_h.html","rtwtypes_h.html"];
