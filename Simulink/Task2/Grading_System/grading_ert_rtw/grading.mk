###########################################################################
## Makefile generated for Simulink model 'grading'. 
## 
## Makefile     : grading.mk
## Generated on : Sun Jan 29 16:38:47 2023
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/grading.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/ITI_Embedded/Courses/MATLAB/Workspace/MBD_Assignments/Grading
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = grading_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = grading_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/grading.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/grading_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=grading -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/grading_ert_rtw/grading.c

MAIN_SRC = $(START_DIR)/grading_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/grading_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
