...
this.def["traffic_light_DW"] = {file: "traffic_light_c.html",line:29,type:"var"};
this.def["traffic_light_Y"] = {file: "traffic_light_c.html",line:32,type:"var"};
this.def["traffic_light_M_"] = {file: "traffic_light_c.html",line:35,type:"var"};
this.def["traffic_light_M"] = {file: "traffic_light_c.html",line:36,type:"var"};
this.def["traffic_light_step"] = {file: "traffic_light_c.html",line:39,type:"fcn"};
this.def["traffic_light_initialize"] = {file: "traffic_light_c.html",line:91,type:"fcn"};
this.def["traffic_light_terminate"] = {file: "traffic_light_c.html",line:128,type:"fcn"};
this.def["DW_traffic_light_T"] = {file: "traffic_light_h.html",line:44,type:"type"};
this.def["ExtY_traffic_light_T"] = {file: "traffic_light_h.html",line:51,type:"type"};
this.def["RT_MODEL_traffic_light_T"] = {file: "traffic_light_types_h.html",line:23,type:"type"};
...
function Html2SrcLink() {
	...
	this.html2SrcPath["traffic_light_c.html"] = "../traffic_light.c";
	this.html2Root["traffic_light_c.html"] = "traffic_light_c.html";
	this.html2SrcPath["traffic_light_h.html"] = "../traffic_light.h";
	this.html2Root["traffic_light_h.html"] = "traffic_light_h.html";
	this.html2SrcPath["traffic_light_private_h.html"] = "../traffic_light_private.h";
	this.html2Root["traffic_light_private_h.html"] = "traffic_light_private_h.html";
	this.html2SrcPath["traffic_light_types_h.html"] = "../traffic_light_types.h";
	this.html2Root["traffic_light_types_h.html"] = "traffic_light_types_h.html";
...
var fileList = [
"ert_main_c.html","traffic_light_c.html","traffic_light_h.html","traffic_light_private_h.html","traffic_light_types_h.html","rtwtypes_h.html"];
